...
public class Combobox<E> extends JComboBox<E> {
    ...
    private @Getter @Setter String labelText = "Label";
    private @Getter @Setter Color lineColor = new Color(3, 155, 216);
    ...
    public class ComboUI extends BasicComboBoxUI {
        ...
        private void createLineStyle(Graphics2D g2) {
            if (isFocusOwner()) {
                ...
                g2.fillRoundRect((int) (x + 2), height - 2, (int) size, 2, 30, 30);
            }
        }
        ...
        private class ArrowButton extends JButton {
            ...
            public ArrowButton() {
                ...
                setBorder(new EmptyBorder(5, 5, 5, 5));
                setBackground(new Color(72,84,254));
            }
